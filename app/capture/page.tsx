      ...
      <div style={{ minHeight: '100vh', background: '#F8F9FF', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 14, color: '#64748B', textAlign: 'center' }}>
            Tomá una foto de tu recibo o factura y te ayudamos a extraer los datos.
          </p>
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <p style={{ fontSize: 12, color: '#94A3B8' }}>Usá la cámara para capturar el recibo</p>
            </div>
          </button>
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <p style={{ fontSize: 12, color: '#94A3B8' }}>Seleccioná una foto de tu galería</p>
            </div>
          </button>
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <p style={{ fontSize: 12, color: '#94A3B8' }}>Escribí los datos del gasto directamente</p>
            </div>
          </button>
          ...
          {confidence != null && (
            <div style={{
              ...
              <span style={{
                ...
                {confidence >= 0.8 ? 'Alta confianza' : confidence >= 0.6 ? 'Confianza media' : 'Baja confianza — revisá los datos'}
              </span>
            </div>
          )}
        </div>
