  ...
  return (
    <div style={{ padding: '12px 16px 0', display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 8 }}>
      ...
      <div style={{ background: 'white', border: '0.5px solid #E2E8F0', borderRadius: 12, padding: '10px 10px 8px', textAlign: 'center' }}>
        <div style={{ fontSize: 11, color: '#94A3B8', fontWeight: 500, letterSpacing: '.04em', marginBottom: 4 }}>HOY</div>
      ...
      <div style={{ background: 'white', border: '0.5px solid #E2E8F0', borderRadius: 12, padding: '10px 10px 8px', textAlign: 'center' }}>
        <div style={{ fontSize: 11, color: '#94A3B8', fontWeight: 500, letterSpacing: '.04em', marginBottom: 4 }}>SEMANA</div>
      ...
      <div style={{ background: 'white', border: '0.5px solid #E2E8F0', borderRadius: 12, padding: '10px 10px 8px', textAlign: 'center' }}>
        <div style={{ fontSize: 11, color: '#94A3B8', fontWeight: 500, letterSpacing: '.04em', marginBottom: 4 }}>MES</div>
