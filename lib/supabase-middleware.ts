...
export async function updateSession(request: NextRequest) {
  ...
  const protectedRoutes = ['/dashboard', '/presupuesto', '/deudas', '/plan', '/historial', '/transacciones', '/familia', '/cuenta', '/onboarding', '/chat', '/capture', '/admin', '/notificacion', '/resumen', '/metas'];
